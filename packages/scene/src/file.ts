...
/**
 * binary file entry stored in `Scene.files`. An
 * `ImageShape` (or other binary-bearing future shape type) carries
 * just a `fileId` and resolves through this registry at render
 * time. The actual bytes live here once, regardless of how many
 * shapes reference them.
 *
