...
So a frame already gives you the two behaviours people usually want from clipping at export time — a bounded region and "crop to this region" on export. Membership is reconciled automatically as you drag shapes in and out of a frame's bounds.
