...
// custom element runs against in-tree code, and lets Vite handle the WASM /
// worker assets the editor loads via `new URL(..., import.meta.url)`.
...
export default defineConfig({
  ...
  server: { port: 5175, fs: { allow: [path.resolve(here, "../..")] } },
  optimizeDeps: {
