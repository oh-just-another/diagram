...
const ALL: ArrowheadStyle[] = [
  "none", "arrow", "openArrow", "roundedArrow", "arcArrow",
  "triangle", "filledArrow", "circle", "filledCircle",
  "diamond", "rhombus", "filledRhombus",
  "erdOne", "erdOnlyOne", "erdMany", "erdOneOrMany", "erdZeroOrOne", "erdZeroOrMany",
];
