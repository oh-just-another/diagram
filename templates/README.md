...
framework-neutral [`<oja-diagram>`](../packages/diagram) custom element, or its
[Vue](../packages/diagram-vue) / [Svelte](../packages/diagram-svelte) /
[Angular](../packages/diagram-angular) wrappers.
