...
Full API reference: [Templates](/docs/sdk-features/content/templates). For a new element *type* (custom geometry, hit-testing, rendering) rather than a palette preset, see `defineShape` in [the shape model](/docs/sdk-features/shapes/model).
