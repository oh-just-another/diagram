// Registers <oja-diagram> as a side effect; markup in index.html mounts it.
...
const SCENE_KEY = "oja-diagram-example-scene";
const FILES_KEY = "oja-diagram-example-files";
