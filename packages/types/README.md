...
| `ShapeId`                                                                                                         | type     | Branded `string` to prevent accidental mixing with other string-shaped IDs.                                                                                                   |
| `shapeId()`                                                                                                       | function | Casts a raw string to `ShapeId`. Caller owns uniqueness.                                                                                                                      |
