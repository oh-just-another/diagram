...
| `eyedropper`   | —      | Colour sampling. Not on the toolbar: armed from the colour picker via `editor.beginEyedropperPick(onPick)`; the next canvas click samples the colour under the cursor.                          |
